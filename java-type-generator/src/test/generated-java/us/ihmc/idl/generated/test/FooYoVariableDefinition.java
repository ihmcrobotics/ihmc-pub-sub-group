...
public class FooYoVariableDefinition extends Packet<FooYoVariableDefinition> implements Settable<FooYoVariableDefinition>, EpsilonComparable<FooYoVariableDefinition>
{
   ...
   public us.ihmc.idl.generated.test.FooYoType type_;
   ...
   public double min_;
   public double max_;
   public us.ihmc.idl.generated.test.FooLoadStatus loadStatus_;
   ...
   public FooYoVariableDefinition(FooYoVariableDefinition other)
   {
      this();
      set(other);
   }
   ...
   public void setType(us.ihmc.idl.generated.test.FooYoType type)
   {
      type_ = type;
   }
   public us.ihmc.idl.generated.test.FooYoType getType()
   {
      return type_;
   }
   ...
   public void setLoadStatus(us.ihmc.idl.generated.test.FooLoadStatus loadStatus)
   {
      loadStatus_ = loadStatus;
   }
   public us.ihmc.idl.generated.test.FooLoadStatus getLoadStatus()
   {
      return loadStatus_;
   }
   ...
   @Override
   public boolean epsilonEquals(FooYoVariableDefinition other, double epsilon)
   {
