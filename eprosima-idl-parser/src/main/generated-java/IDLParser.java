...
public class IDLParser extends Parser {
	...
	public final MemberContext member() throws RecognitionException {
		...
		try {
			...
			setState(1020); ((MemberContext)_localctx).declarators = declarators();
			setState(1021); match(SEMICOLON);
	...
	public final Union_typeContext union_type() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1024); match(KW_UNION);
			setState(1025); ((Union_typeContext)_localctx).identifier = identifier();
			 name=((Union_typeContext)_localctx).identifier.id;
			setState(1027); match(KW_SWITCH);
			setState(1028); match(LEFT_BRACKET);
			setState(1029); ((Union_typeContext)_localctx).switch_type_spec = switch_type_spec();
			 dist_type=((Union_typeContext)_localctx).switch_type_spec.typecode; 
			setState(1031); match(RIGHT_BRACKET);
			...
			setState(1033); match(LEFT_BRACE);
			setState(1034); switch_body(unionTP);
	...
	public final Switch_type_specContext switch_type_spec() throws RecognitionException {
		...
		try {
			...
			case KW_UNSIGNED:
				enterOuterAlt(_localctx, 1);
				{
				setState(1038); ((Switch_type_specContext)_localctx).integer_type = integer_type();
			...
			case KW_CHAR:
				enterOuterAlt(_localctx, 2);
				{
				setState(1041); ((Switch_type_specContext)_localctx).char_type = char_type();
			...
			case KW_BOOLEAN:
				enterOuterAlt(_localctx, 3);
				{
				setState(1044); ((Switch_type_specContext)_localctx).boolean_type = boolean_type();
			...
			case ID:
				enterOuterAlt(_localctx, 5);
				{
				setState(1048); ((Switch_type_specContext)_localctx).scoped_name = scoped_name();
	...
	public final Switch_bodyContext switch_body(UnionTypeCode unionTP) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1053); case_stmt_list(unionTP);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Case_stmt_listContext case_stmt_list(UnionTypeCode unionTP) throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(1055); case_stmt(unionTP);
				}
				}
				setState(1058); 
				_errHandler.sync(this);
	...
	public final Case_stmtContext case_stmt(UnionTypeCode unionTP) throws RecognitionException {
		...
		try {
			...
			do {
				...
				case KW_CASE:
					{
					setState(1060); match(KW_CASE);
					setState(1061); ((Case_stmtContext)_localctx).const_exp = const_exp();
				...
				case KW_DEFAULT:
					{
					setState(1065); match(KW_DEFAULT);
					 defaul = true; 
			...
			setState(1072); ((Case_stmtContext)_localctx).element_spec = element_spec(labels, defaul);
			setState(1073); match(SEMICOLON);
	...
	public final Element_specContext element_spec(List<String> labels,boolean isDefault) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1076); ((Element_specContext)_localctx).type_spec = type_spec();
			setState(1077); ((Element_specContext)_localctx).declarator = declarator();
	...
	public final Enum_typeContext enum_type() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1080); match(KW_ENUM);
			setState(1081); ((Enum_typeContext)_localctx).identifier = identifier();
			 name=((Enum_typeContext)_localctx).identifier.id; enumTP = new EnumTypeCode(ctx.getScope(), name); 
			setState(1083); match(LEFT_BRACE);
			setState(1084); enumerator_list(enumTP);
			setState(1085); match(RIGHT_BRACE);
	...
	public final Enumerator_listContext enumerator_list(EnumTypeCode enumTP) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1088); enumerator(enumTP);
			setState(1093);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMA) {
				{
				{
				setState(1089); match(COMA);
				setState(1090); enumerator(enumTP);
				}
				}
				setState(1095);
				_errHandler.sync(this);
	...
	public final EnumeratorContext enumerator(EnumTypeCode enumTP) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1096); ((EnumeratorContext)_localctx).identifier = identifier();
	...
	public final Sequence_typeContext sequence_type() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				{
				setState(1099); match(KW_SEQUENCE);
				}
				setState(1100); match(LEFT_ANG_BRACKET);
				setState(1101); ((Sequence_typeContext)_localctx).simple_type_spec = simple_type_spec();
				 type=((Sequence_typeContext)_localctx).simple_type_spec.typecode; 
				setState(1103); match(COMA);
				setState(1104); ((Sequence_typeContext)_localctx).positive_int_const = positive_int_const();
				 maxsize=((Sequence_typeContext)_localctx).positive_int_const.literalStr; 
				setState(1106); match(RIGHT_ANG_BRACKET);
				}
				break;
			...
			case 2:
				{
				{
				setState(1108); match(KW_SEQUENCE);
				}
				setState(1109); match(LEFT_ANG_BRACKET);
				setState(1110); ((Sequence_typeContext)_localctx).simple_type_spec = simple_type_spec();
				 type=((Sequence_typeContext)_localctx).simple_type_spec.typecode; 
				setState(1112); match(RIGHT_ANG_BRACKET);
				}
				break;
			}
	...
	public final String_typeContext string_type() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1118); match(KW_STRING);
				setState(1119); match(LEFT_ANG_BRACKET);
				setState(1120); ((String_typeContext)_localctx).positive_int_const = positive_int_const();
				 maxsize=((String_typeContext)_localctx).positive_int_const.literalStr; 
				setState(1122); match(RIGHT_ANG_BRACKET);
				}
				break;

			case 2:
				{
				setState(1124); match(KW_STRING);
				}
				break;
			}
	...
	public final Wide_string_typeContext wide_string_type() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1129); match(KW_WSTRING);
				setState(1130); match(LEFT_ANG_BRACKET);
				setState(1131); ((Wide_string_typeContext)_localctx).positive_int_const = positive_int_const();
				 maxsize=((Wide_string_typeContext)_localctx).positive_int_const.literalStr; 
				setState(1133); match(RIGHT_ANG_BRACKET);
				}
				break;

			case 2:
				{
				setState(1135); match(KW_WSTRING);
				}
				break;
			}
	...
	public final Array_declaratorContext array_declarator() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(1141); ((Array_declaratorContext)_localctx).fixed_array_size = fixed_array_size();
	...
	public final Fixed_array_sizeContext fixed_array_size() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1150); match(LEFT_SQUARE_BRACKET);
			setState(1151); ((Fixed_array_sizeContext)_localctx).positive_int_const = positive_int_const();
			 ((Fixed_array_sizeContext)_localctx).literalStr = ((Fixed_array_sizeContext)_localctx).positive_int_const.literalStr; 
			setState(1153); match(RIGHT_SQUARE_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Attr_declContext attr_decl() throws RecognitionException {
		...
		try {
			...
			case KW_READONLY:
				enterOuterAlt(_localctx, 1);
				{
				setState(1155); readonly_attr_spec();
				}
				break;
			case KW_ATTRIBUTE:
				enterOuterAlt(_localctx, 2);
				{
				setState(1156); ((Attr_declContext)_localctx).attr_spec = attr_spec();
	...
	public final Except_declContext except_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1161); match(KW_EXCEPTION);

			            tk = _input.LT(1);
			        
			setState(1163); ((Except_declContext)_localctx).identifier = identifier();
			...
			setState(1166); match(LEFT_BRACE);
			setState(1167); opt_member_list(exceptionObject);
			setState(1168); match(RIGHT_BRACE);
	...
	public final Opt_member_listContext opt_member_list(com.eprosima.idl.parser.tree.Exception exceptionObject) throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << DOUBLE_COLON) | (1L << KW_STRING) | (1L << KW_OCTET) | (1L << KW_SEQUENCE) | (1L << KW_STRUCT) | (1L << KW_WCHAR) | (1L << KW_SHORT))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (KW_LONG - 64)) | (1L << (KW_ENUM - 64)) | (1L << (KW_WSTRING - 64)) | (1L << (KW_VALUEBASE - 64)) | (1L << (KW_OBJECT - 64)) | (1L << (KW_UNSIGNED - 64)) | (1L << (KW_FIXED - 64)) | (1L << (KW_UNION - 64)) | (1L << (KW_ANY - 64)) | (1L << (KW_CHAR - 64)) | (1L << (KW_FLOAT - 64)) | (1L << (KW_BOOLEAN - 64)) | (1L << (KW_DOUBLE - 64)) | (1L << (ID - 64)))) != 0)) {
				{
				{
				setState(1171); ((Opt_member_listContext)_localctx).member = member();
	...
	public final Op_declContext op_decl(Vector<Annotation> annotations) throws RecognitionException {
		...
		try {
			...
			if (_la==KW_ONEWAY) {
				{
				setState(1179); ((Op_declContext)_localctx).op_attribute = op_attribute();
				 tkoneway=((Op_declContext)_localctx).op_attribute.token; 
				}
			}

			setState(1184); ((Op_declContext)_localctx).op_type_spec = op_type_spec();
			...
			setState(1189); ((Op_declContext)_localctx).parameter_decls = parameter_decls(operationObject);
			 tpl=((Op_declContext)_localctx).parameter_decls.tpl; 
			setState(1195);
			_la = _input.LA(1);
			if (_la==KW_RAISES) {
				{
				setState(1191); ((Op_declContext)_localctx).raises_expr = raises_expr();
	...
	public final Op_type_specContext op_type_spec() throws RecognitionException {
		...
		try {
			...
			case ID:
				enterOuterAlt(_localctx, 1);
				{
				setState(1205); ((Op_type_specContext)_localctx).param_type_spec = param_type_spec();
	...
	public final Parameter_declsContext parameter_decls(Operation operation) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1211); match(LEFT_BRACKET);
			setState(1213);
			_la = _input.LA(1);
			if (((((_la - 39)) & ~0x3f) == 0 && ((1L << (_la - 39)) & ((1L << (KW_OUT - 39)) | (1L << (KW_IN - 39)) | (1L << (KW_INOUT - 39)))) != 0)) {
				{
				setState(1212); param_decl_list(operation, _localctx.tpl);
				}
			}

			setState(1215); match(RIGHT_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Param_decl_listContext param_decl_list(Operation operation,TemplateGroup tpl) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1217); ((Param_decl_listContext)_localctx).param_decl = param_decl();
			...
			while (_la==COMA) {
				{
				{
				setState(1220); match(COMA);
				setState(1221); ((Param_decl_listContext)_localctx).param_decl = param_decl();
				 ptg=((Param_decl_listContext)_localctx).param_decl.returnPair; 
	...
	public final Param_declContext param_decl() throws RecognitionException {
		...
		try {
			...
			consume();
			setState(1231); ((Param_declContext)_localctx).param_type_spec = param_type_spec();
			 typecode=((Param_declContext)_localctx).param_type_spec.typecode; 
			setState(1233); ((Param_declContext)_localctx).simple_declarator = simple_declarator();
	...
	public final Raises_exprContext raises_expr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1236); match(KW_RAISES);
			setState(1237); match(LEFT_BRACKET);
			setState(1238); ((Raises_exprContext)_localctx).scoped_name_list = scoped_name_list();
			 ((Raises_exprContext)_localctx).exlist = ((Raises_exprContext)_localctx).scoped_name_list.retlist; 
			setState(1240); match(RIGHT_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Context_exprContext context_expr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1242); match(KW_CONTEXT);
			setState(1243); match(LEFT_BRACKET);
			setState(1244); match(STRING_LITERAL);
			setState(1249);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMA) {
				{
				{
				setState(1245); match(COMA);
				setState(1246); match(STRING_LITERAL);
				}
				}
				setState(1251);
				_errHandler.sync(this);
			...
			setState(1252); match(RIGHT_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Param_type_specContext param_type_spec() throws RecognitionException {
		...
		try {
			...
			case KW_DOUBLE:
				enterOuterAlt(_localctx, 1);
				{
				setState(1254); ((Param_type_specContext)_localctx).base_type_spec = base_type_spec();
			...
			case KW_STRING:
				enterOuterAlt(_localctx, 2);
				{
				setState(1257); ((Param_type_specContext)_localctx).string_type = string_type();
			...
			case KW_WSTRING:
				enterOuterAlt(_localctx, 3);
				{
				setState(1260); ((Param_type_specContext)_localctx).wide_string_type = wide_string_type();
			...
			case ID:
				enterOuterAlt(_localctx, 4);
				{
				setState(1263); ((Param_type_specContext)_localctx).scoped_name = scoped_name();
	...
	public final Fixed_pt_typeContext fixed_pt_type() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1268); match(KW_FIXED);
			setState(1269); match(LEFT_ANG_BRACKET);
			setState(1270); positive_int_const();
			setState(1271); match(COMA);
			setState(1272); positive_int_const();
			setState(1273); match(RIGHT_ANG_BRACKET);
	...
	public final Value_base_typeContext value_base_type() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1279); match(KW_VALUEBASE);
	...
	public final Constr_forward_declContext constr_forward_decl() throws RecognitionException {
		...
		try {
			...
			case KW_STRUCT:
				enterOuterAlt(_localctx, 1);
				{
				setState(1282); match(KW_STRUCT);
				setState(1283); match(ID);
				}
				break;
			case KW_UNION:
				enterOuterAlt(_localctx, 2);
				{
				setState(1284); match(KW_UNION);
	...
	public final Import_declContext import_decl() throws RecognitionException {
		...
		try {
			...
			setState(1290); imported_scope();
			setState(1291); match(SEMICOLON);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Imported_scopeContext imported_scope() throws RecognitionException {
		...
		try {
			...
			case ID:
				enterOuterAlt(_localctx, 1);
				{
				setState(1293); scoped_name();
				}
				break;
			case STRING_LITERAL:
				enterOuterAlt(_localctx, 2);
				{
				setState(1294); match(STRING_LITERAL);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Type_id_declContext type_id_decl() throws RecognitionException {
		...
		try {
			...
			setState(1299); scoped_name();
			setState(1300); match(STRING_LITERAL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Type_prefix_declContext type_prefix_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1302); match(KW_TYPEPREFIX);
			...
			setState(1304); scoped_name();
			setState(1305); match(STRING_LITERAL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Readonly_attr_specContext readonly_attr_spec() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1307); match(KW_READONLY);
			setState(1308); match(KW_ATTRIBUTE);
			setState(1309); param_type_spec();
			setState(1310); readonly_attr_declarator();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Readonly_attr_declaratorContext readonly_attr_declarator() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1312); simple_declarator();
				setState(1313); raises_expr();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1315); simple_declarator();
				setState(1320);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMA) {
					{
					{
					setState(1316); match(COMA);
					setState(1317); simple_declarator();
					}
					}
					setState(1322);
					_errHandler.sync(this);
	...
	public final Attr_specContext attr_spec() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1325); match(KW_ATTRIBUTE);
			setState(1326); ((Attr_specContext)_localctx).param_type_spec = param_type_spec();
			 typecode=((Attr_specContext)_localctx).param_type_spec.typecode; 
			setState(1328); ((Attr_specContext)_localctx).attr_declarator = attr_declarator();
	...
	public final Attr_declaratorContext attr_declarator() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1331); ((Attr_declaratorContext)_localctx).simple_declarator = simple_declarator();
			...
			case KW_GETRAISES:
				{
				setState(1333); attr_raises_expr();
				}
				break;
			case SEMICOLON:
			case COMA:
				...
				while (_la==COMA) {
					{
					{
					setState(1334); match(COMA);
					setState(1335); ((Attr_declaratorContext)_localctx).simple_declarator = simple_declarator();
					_localctx.ret.add(((Attr_declaratorContext)_localctx).simple_declarator.ret);
					}
					}
					setState(1342);
	...
	public final Attr_raises_exprContext attr_raises_expr() throws RecognitionException {
		...
		try {
			...
			case KW_GETRAISES:
				enterOuterAlt(_localctx, 1);
				{
				setState(1345); get_excep_expr();
				setState(1347);
				_la = _input.LA(1);
				if (_la==KW_SETRAISES) {
					{
					setState(1346); set_excep_expr();
					}
				}
	...
	public final Get_excep_exprContext get_excep_expr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1352); match(KW_GETRAISES);
			setState(1353); exception_list();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Set_excep_exprContext set_excep_expr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1355); match(KW_SETRAISES);
			setState(1356); exception_list();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Exception_listContext exception_list() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1358); match(LEFT_BRACKET);
			setState(1359); scoped_name();
			setState(1364);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMA) {
				{
				{
				setState(1360); match(COMA);
				setState(1361); scoped_name();
				}
				}
				setState(1366);
				_errHandler.sync(this);
			...
			setState(1367); match(RIGHT_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ComponentContext component() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1370); component_forward_decl();
				}
				break;
			}
		}
	...
	public final Component_forward_declContext component_forward_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1373); match(KW_COMPONENT);
	...
	public final Component_declContext component_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1377); component_header();
			setState(1378); match(LEFT_BRACE);
			setState(1379); component_body();
			setState(1380); match(RIGHT_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Component_headerContext component_header() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1382); match(KW_COMPONENT);
			setState(1383); match(ID);
			setState(1385);
			_la = _input.LA(1);
			if (_la==COLON) {
				{
				setState(1384); component_inheritance_spec();
				}
			}
			...
			if (_la==KW_SUPPORTS) {
				{
				setState(1387); supported_interface_spec();
				}
			}
	...
	public final Supported_interface_specContext supported_interface_spec() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1390); match(KW_SUPPORTS);
			setState(1391); scoped_name();
			setState(1396);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMA) {
				{
				{
				setState(1392); match(COMA);
				setState(1393); scoped_name();
				}
				}
				setState(1398);
				_errHandler.sync(this);
	...
	public final Component_inheritance_specContext component_inheritance_spec() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1399); match(COLON);
			setState(1400); scoped_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Component_bodyContext component_body() throws RecognitionException {
		...
		try {
			...
			while (((((_la - 40)) & ~0x3f) == 0 && ((1L << (_la - 40)) & ((1L << (KW_EMITS - 40)) | (1L << (KW_PUBLISHES - 40)) | (1L << (KW_USES - 40)) | (1L << (KW_READONLY - 40)) | (1L << (KW_PROVIDES - 40)) | (1L << (KW_CONSUMES - 40)) | (1L << (KW_ATTRIBUTE - 40)))) != 0)) {
				{
				{
				setState(1402); component_export();
				}
				}
				setState(1407);
				_errHandler.sync(this);
	...
	public final Component_exportContext component_export() throws RecognitionException {
		...
		try {
			...
			case KW_PROVIDES:
				enterOuterAlt(_localctx, 1);
				{
				setState(1408); provides_decl();
				setState(1409); match(SEMICOLON);
				}
				break;
			case KW_USES:
				enterOuterAlt(_localctx, 2);
				{
				setState(1411); uses_decl();
				setState(1412); match(SEMICOLON);
				}
				break;
			case KW_EMITS:
				enterOuterAlt(_localctx, 3);
				{
				setState(1414); emits_decl();
				setState(1415); match(SEMICOLON);
				}
				break;
			case KW_PUBLISHES:
				enterOuterAlt(_localctx, 4);
				{
				setState(1417); publishes_decl();
			...
			case KW_ATTRIBUTE:
				enterOuterAlt(_localctx, 6);
				{
				setState(1423); attr_decl();
				setState(1424); match(SEMICOLON);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Provides_declContext provides_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1428); match(KW_PROVIDES);
			setState(1429); interface_type();
			setState(1430); match(ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Interface_typeContext interface_type() throws RecognitionException {
		...
		try {
			...
			case ID:
				enterOuterAlt(_localctx, 1);
				{
				setState(1432); scoped_name();
				}
				break;
			case KW_OBJECT:
				enterOuterAlt(_localctx, 2);
				{
				setState(1433); match(KW_OBJECT);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Uses_declContext uses_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1436); match(KW_USES);
			setState(1438);
			_la = _input.LA(1);
			if (_la==KW_MULTIPLE) {
				{
				setState(1437); match(KW_MULTIPLE);
				}
			}

			setState(1440); interface_type();
			setState(1441); match(ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Emits_declContext emits_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1443); match(KW_EMITS);
			setState(1444); scoped_name();
			setState(1445); match(ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Publishes_declContext publishes_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1447); match(KW_PUBLISHES);
			setState(1448); scoped_name();
			setState(1449); match(ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Consumes_declContext consumes_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1451); match(KW_CONSUMES);
			setState(1452); scoped_name();
			setState(1453); match(ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Home_declContext home_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1455); home_header();
			setState(1456); home_body();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Home_headerContext home_header() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1458); match(KW_HOME);
			setState(1459); match(ID);
			setState(1461);
			_la = _input.LA(1);
			if (_la==COLON) {
				{
				setState(1460); home_inheritance_spec();
				}
			}
			...
			if (_la==KW_SUPPORTS) {
				{
				setState(1463); supported_interface_spec();
				}
			}

			setState(1466); match(KW_MANAGES);
			setState(1467); scoped_name();
			setState(1469);
			_la = _input.LA(1);
			if (_la==KW_PRIMARYKEY) {
				{
				setState(1468); primary_key_spec();
				}
			}
	...
	public final Home_inheritance_specContext home_inheritance_spec() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1471); match(COLON);
			setState(1472); scoped_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Primary_key_specContext primary_key_spec() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1474); match(KW_PRIMARYKEY);
			setState(1475); scoped_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Home_bodyContext home_body() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1477); match(LEFT_BRACE);
			setState(1481);
			_errHandler.sync(this);
			_la = _input.LA(1);
			...
			setState(1484); match(RIGHT_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Home_exportContext home_export() throws RecognitionException {
		...
		try {
			...
			case ID:
				enterOuterAlt(_localctx, 1);
				{
				setState(1486); export(null);
				}
				break;
			case KW_FACTORY:
				enterOuterAlt(_localctx, 2);
				{
				setState(1487); factory_decl();
				setState(1488); match(SEMICOLON);
				}
				break;
			case KW_FINDER:
				enterOuterAlt(_localctx, 3);
				{
				setState(1490); finder_decl();
				setState(1491); match(SEMICOLON);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Factory_declContext factory_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1495); match(KW_FACTORY);
			setState(1496); match(ID);
			setState(1497); match(LEFT_BRACKET);
			setState(1499);
			_la = _input.LA(1);
			if (_la==KW_IN) {
				{
				setState(1498); init_param_decls();
				}
			}

			setState(1501); match(RIGHT_BRACKET);
			setState(1503);
			_la = _input.LA(1);
			if (_la==KW_RAISES) {
				{
				setState(1502); raises_expr();
				}
			}
	...
	public final Finder_declContext finder_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1505); match(KW_FINDER);
			setState(1506); match(ID);
			setState(1507); match(LEFT_BRACKET);
			setState(1509);
			_la = _input.LA(1);
			if (_la==KW_IN) {
				{
				setState(1508); init_param_decls();
				}
			}

			setState(1511); match(RIGHT_BRACKET);
			setState(1513);
			_la = _input.LA(1);
			if (_la==KW_RAISES) {
				{
				setState(1512); raises_expr();
				}
			}
	...
	public final EventContext event() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1515); event_decl();
				}
				break;

			case 2:
				{
				setState(1516); event_abs_decl();
				}
				break;

			case 3:
				{
				setState(1517); event_forward_decl();
				}
				break;
			}
			}
	...
	public final Event_forward_declContext event_forward_decl() throws RecognitionException {
		...
		try {
			...
			if (_la==KW_ABSTRACT) {
				{
				setState(1520); match(KW_ABSTRACT);
				}
			}

			setState(1523); match(KW_EVENTTYPE);
			setState(1524); match(ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Event_abs_declContext event_abs_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1526); match(KW_ABSTRACT);
			setState(1527); match(KW_EVENTTYPE);
			setState(1528); match(ID);
			setState(1529); value_inheritance_spec();
			setState(1530); match(LEFT_BRACE);
			setState(1534);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << AT) | (1L << DOUBLE_COLON) | (1L << KW_STRING) | (1L << KW_TYPEDEF) | (1L << KW_OCTET) | (1L << KW_STRUCT) | (1L << KW_NATIVE) | (1L << KW_READONLY) | (1L << KW_VOID) | (1L << KW_WCHAR) | (1L << KW_SHORT))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (KW_LONG - 64)) | (1L << (KW_ENUM - 64)) | (1L << (KW_WSTRING - 64)) | (1L << (KW_EXCEPTION - 64)) | (1L << (KW_CONST - 64)) | (1L << (KW_VALUEBASE - 64)) | (1L << (KW_OBJECT - 64)) | (1L << (KW_UNSIGNED - 64)) | (1L << (KW_UNION - 64)) | (1L << (KW_ONEWAY - 64)) | (1L << (KW_ANY - 64)) | (1L << (KW_CHAR - 64)) | (1L << (KW_FLOAT - 64)) | (1L << (KW_BOOLEAN - 64)) | (1L << (KW_DOUBLE - 64)) | (1L << (KW_TYPEPREFIX - 64)) | (1L << (KW_TYPEID - 64)) | (1L << (KW_ATTRIBUTE - 64)) | (1L << (ID - 64)))) != 0)) {
			...
			setState(1537); match(RIGHT_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Event_declContext event_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1539); event_header();
			setState(1540); match(LEFT_BRACE);
			setState(1544);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << AT) | (1L << DOUBLE_COLON) | (1L << KW_STRING) | (1L << KW_TYPEDEF) | (1L << KW_OCTET) | (1L << KW_STRUCT) | (1L << KW_NATIVE) | (1L << KW_READONLY) | (1L << KW_VOID) | (1L << KW_PRIVATE) | (1L << KW_WCHAR) | (1L << KW_PUBLIC) | (1L << KW_SHORT))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (KW_LONG - 64)) | (1L << (KW_ENUM - 64)) | (1L << (KW_WSTRING - 64)) | (1L << (KW_FACTORY - 64)) | (1L << (KW_EXCEPTION - 64)) | (1L << (KW_CONST - 64)) | (1L << (KW_VALUEBASE - 64)) | (1L << (KW_OBJECT - 64)) | (1L << (KW_UNSIGNED - 64)) | (1L << (KW_UNION - 64)) | (1L << (KW_ONEWAY - 64)) | (1L << (KW_ANY - 64)) | (1L << (KW_CHAR - 64)) | (1L << (KW_FLOAT - 64)) | (1L << (KW_BOOLEAN - 64)) | (1L << (KW_DOUBLE - 64)) | (1L << (KW_TYPEPREFIX - 64)) | (1L << (KW_TYPEID - 64)) | (1L << (KW_ATTRIBUTE - 64)) | (1L << (ID - 64)))) != 0)) {
			...
			setState(1547); match(RIGHT_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Event_headerContext event_header() throws RecognitionException {
		...
		try {
			...
			if (_la==KW_CUSTOM) {
				{
				setState(1549); match(KW_CUSTOM);
				}
			}

			setState(1552); match(KW_EVENTTYPE);
			setState(1553); match(ID);
			setState(1554); value_inheritance_spec();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Annotation_applContext annotation_appl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1556); match(AT);
			setState(1557); ((Annotation_applContext)_localctx).scoped_name = scoped_name();
			...
			if (_la==LEFT_BRACKET) {
				{
				setState(1559); match(LEFT_BRACKET);
				setState(1561);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 1) | (1L << 2) | (1L << INTEGER_LITERAL) | (1L << HEX_LITERAL) | (1L << FLOATING_PT_LITERAL) | (1L << FIXED_PT_LITERAL) | (1L << WIDE_CHARACTER_LITERAL) | (1L << CHARACTER_LITERAL) | (1L << WIDE_STRING_LITERAL) | (1L << STRING_LITERAL) | (1L << LEFT_BRACKET) | (1L << TILDE) | (1L << PLUS) | (1L << MINUS) | (1L << DOUBLE_COLON))) != 0) || _la==ID) {
					{
					setState(1560); annotation_appl_params(_localctx.annotation, ((Annotation_applContext)_localctx).scoped_name.pair.second());
					}
				}

				setState(1563); match(RIGHT_BRACKET);
				}
			}
	...
	public final Annotation_appl_paramsContext annotation_appl_params(Annotation annotation,Token tkannot) throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1566); ((Annotation_appl_paramsContext)_localctx).const_exp = const_exp();
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1569); annotation_appl_param(annotation);
				setState(1574);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMA) {
					{
					{
					setState(1570); match(COMA);
					setState(1571); annotation_appl_param(annotation);
					}
					}
					setState(1576);
					_errHandler.sync(this);
	...
	public final Annotation_appl_paramContext annotation_appl_param(Annotation annotation) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1579); ((Annotation_appl_paramContext)_localctx).identifier = identifier();
			setState(1580); match(EQUAL);
			setState(1581); ((Annotation_appl_paramContext)_localctx).const_exp = const_exp();
	...
	public static final String _serializedATN =
		...
		"Q\u03fc\nQ\3R\3R\3R\3R\3R\3S\3S\3S\3S\3S\3S\3S\3S\3S\3S\3S\3S\3S\