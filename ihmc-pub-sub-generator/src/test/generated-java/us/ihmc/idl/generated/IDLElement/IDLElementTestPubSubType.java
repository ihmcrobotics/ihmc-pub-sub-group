...
*
*/
public class IDLElementTestPubSubType implements us.ihmc.pubsub.TopicDataType<us.ihmc.idl.generated.IDLElement.IDLElementTest>
{
	public static final java.lang.String name = "IDLElement::IDLElementTest";
    ...
    @Override
   public void serialize(us.ihmc.idl.generated.IDLElement.IDLElementTest data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, us.ihmc.idl.generated.IDLElement.IDLElementTest data) throws java.io.IOException
   {
	...
	public static int getMaxCdrSerializedSize(int current_alignment)
	{
	    ...
	    current_alignment += us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType.getMaxCdrSerializedSize(current_alignment);
	    ...
	    current_alignment += 4 + us.ihmc.idl.CDR.alignment(current_alignment, 4);
	    current_alignment += (25 * 2) + us.ihmc.idl.CDR.alignment(current_alignment, 2);
	    ...
	    current_alignment += 4 + us.ihmc.idl.CDR.alignment(current_alignment, 4);
	    current_alignment += (25 * 8) + us.ihmc.idl.CDR.alignment(current_alignment, 8);
	...
	public final static int getCdrSerializedSize(us.ihmc.idl.generated.IDLElement.IDLElementTest data)
	{
		return getCdrSerializedSize(data, 0);
	}

	public final static int getCdrSerializedSize(us.ihmc.idl.generated.IDLElement.IDLElementTest data, int current_alignment)
	{
	    int initial_alignment = current_alignment;
	    ...
	    current_alignment += us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType.getCdrSerializedSize(data.getNestedElementTest(), current_alignment);
	    ...
	    for(int a = 0; a < data.getNestedArray().length; ++a)
	    {
	        ...
	        {
	                current_alignment += us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType.getCdrSerializedSize(data.getNestedArray()[a][b], current_alignment);
	        }
	    }
	    for(int a = 0; a < data.getStringArray().length; ++a)
	    {
	            current_alignment += 4 + us.ihmc.idl.CDR.alignment(current_alignment, 4) + data.getStringArray()[a].length() + 1;
	    ...
	    {
	        current_alignment += us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType.getCdrSerializedSize(data.getNestedSeqTest().get(a), current_alignment);}

	    current_alignment += 4 + us.ihmc.idl.CDR.alignment(current_alignment, 4);
	    for(int a = 0; a < data.getStringSeqTest().size(); ++a)
	    {
	        current_alignment += 4 + us.ihmc.idl.CDR.alignment(current_alignment, 4) + data.getStringSeqTest().get(a).length() + 1;
	    }
	
	    return current_alignment - initial_alignment;
	}
	
   public static void write(us.ihmc.idl.generated.IDLElement.IDLElementTest data, us.ihmc.idl.CDR cdr)
   {
	    ...
	    us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType.write(data.getNestedElementTest(), cdr);
	    ...
	    for(int a = 0; a < data.getLongArray().length; ++a)
	    {
	        	cdr.write_type_2(data.getLongArray()[a]);	
	    }
	    ...
	    for(int a = 0; a < data.getNestedArray().length; ++a)
	    {
	        for(int b = 0; b < data.getNestedArray()[a].length; ++b)
	        {
	            	us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType.write(data.getNestedArray()[a][b], cdr);		
	        }
	    }
	    ...
	    for(int a = 0; a < data.getStringArray().length; ++a)
	    {
	        	cdr.write_type_d(data.getStringArray()[a]);	
	    }
   ...
   public static void read(us.ihmc.idl.generated.IDLElement.IDLElementTest data, us.ihmc.idl.CDR cdr)
   {
	    	...
	    	data.setColorTest(us.ihmc.idl.generated.IDLElement.Color.values[cdr.read_type_c()]);
	    	

	    	us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType.read(data.getNestedElementTest(), cdr);	

	    	cdr.read_type_d(data.getStringTest());	

	    	for(int a = 0; a < data.getLongArray().length; ++a)
	    	{
	    	    	data.getLongArray()[a] = cdr.read_type_2();
	    	...
	    	for(int a = 0; a < data.getNestedArray().length; ++a)
	    	{
	    	    for(int b = 0; b < data.getNestedArray()[a].length; ++b)
	    	    {
	    	        	us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType.read(data.getNestedArray()[a][b], cdr);	
	    	    }
	    	}
	    	...
	    	for(int a = 0; a < data.getStringArray().length; ++a)
	    	{
	    	    	cdr.read_type_d(data.getStringArray()[a]);	
	    	}
	...
	@Override
	public final void serialize(us.ihmc.idl.generated.IDLElement.IDLElementTest data, us.ihmc.idl.InterchangeSerializer ser)
	{
			    ...
			    ser.write_type_a("nestedElementTest", new us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType(), data.getNestedElementTest());

			    
			    ser.write_type_d("stringTest", data.getStringTest());
			    
				    	ser.write_type_f("longArray", data.getLongArray());	    
				    	ser.write_type_f("nestedArray", new us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType(), data.getNestedArray());	    
	...
	@Override
	public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, us.ihmc.idl.generated.IDLElement.IDLElementTest data)
	{
	    			...
	    			data.setColorTest((us.ihmc.idl.generated.IDLElement.Color)ser.read_type_c("colorTest", us.ihmc.idl.generated.IDLElement.Color.class));
	    	
	    	    
	    			ser.read_type_a("nestedElementTest", new us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType(), data.getNestedElementTest());
	    			...
	    			ser.read_type_d("stringTest", data.getStringTest());	
	    		    	...
	    		    	ser.read_type_f("nestedArray", new us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType(), data.getNestedArray());			
   ...
   public static void staticCopy(us.ihmc.idl.generated.IDLElement.IDLElementTest src, us.ihmc.idl.generated.IDLElement.IDLElementTest dest)
   {
      dest.set(src);
   }
   ...
   @Override
   public us.ihmc.idl.generated.IDLElement.IDLElementTest createData()
   {
      return new us.ihmc.idl.generated.IDLElement.IDLElementTest();
   }
   ...
   public void serialize(us.ihmc.idl.generated.IDLElement.IDLElementTest data, us.ihmc.idl.CDR cdr)
	{
		write(data, cdr);
	}

   public void deserialize(us.ihmc.idl.generated.IDLElement.IDLElementTest data, us.ihmc.idl.CDR cdr)
   {
        read(data, cdr);
   }
   
   public void copy(us.ihmc.idl.generated.IDLElement.IDLElementTest src, us.ihmc.idl.generated.IDLElement.IDLElementTest dest)
   {
      staticCopy(src, dest);
   }	
