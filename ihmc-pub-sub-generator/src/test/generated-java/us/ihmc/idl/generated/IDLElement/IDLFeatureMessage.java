...
public class IDLFeatureMessage extends Packet<IDLFeatureMessage> implements Settable<IDLFeatureMessage>, EpsilonComparable<IDLFeatureMessage>
{
    ...
    */
   public int hello_;
   public us.ihmc.idl.generated.IDLElement.IDLSubmessage num1_;
   public us.ihmc.idl.IDLSequence.Object<us.ihmc.idl.generated.IDLElement.IDLSubmessage>  num2_;
   /**
    * Should be ros_msgs::msg::dds::Num num3[3];
    */
   public us.ihmc.idl.generated.IDLElement.IDLSubmessage[] num3_;
   public us.ihmc.idl.IDLSequence.Object<us.ihmc.idl.generated.IDLElement.IDLSubmessage>  num4_;
   ...
   {
      num1_ = new us.ihmc.idl.generated.IDLElement.IDLSubmessage();
      num2_ = new us.ihmc.idl.IDLSequence.Object<us.ihmc.idl.generated.IDLElement.IDLSubmessage> (100, us.ihmc.idl.generated.IDLElement.IDLSubmessage.class, new us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType());
      num3_ = new us.ihmc.idl.generated.IDLElement.IDLSubmessage[3];

      for(int i1 = 0; i1 < num3_.length; ++i1)
      {
          num3_[i1] = new us.ihmc.idl.generated.IDLElement.IDLSubmessage();
      }
      num4_ = new us.ihmc.idl.IDLSequence.Object<us.ihmc.idl.generated.IDLElement.IDLSubmessage> (3, us.ihmc.idl.generated.IDLElement.IDLSubmessage.class, new us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType());
   ...
   public void set(IDLFeatureMessage other)
   {
      ...
      us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType.staticCopy(other.num1_, num1_);
      num2_.set(other.num2_);
      for(int i3 = 0; i3 < num3_.length; ++i3)
      {
            us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType.staticCopy(other.num3_[i3], num3_[i3]);}
   ...
   public us.ihmc.idl.generated.IDLElement.IDLSubmessage getNum1()
   {
      return num1_;
   }


   public us.ihmc.idl.IDLSequence.Object<us.ihmc.idl.generated.IDLElement.IDLSubmessage>  getNum2()
   {
      return num2_;
   }
    ...
    * Should be ros_msgs::msg::dds::Num num3[3];
    */
   public us.ihmc.idl.generated.IDLElement.IDLSubmessage[] getNum3()
   {
      return num3_;
   }


   public us.ihmc.idl.IDLSequence.Object<us.ihmc.idl.generated.IDLElement.IDLSubmessage>  getNum4()
   {
      return num4_;
   }
