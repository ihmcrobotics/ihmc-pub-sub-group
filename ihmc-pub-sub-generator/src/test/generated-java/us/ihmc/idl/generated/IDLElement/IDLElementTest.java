...
public class IDLElementTest
{
    ...
    {
        	nestedElementTest_ = new us.ihmc.idl.generated.IDLNestedElement.NestedElement();stringTest_ = new java.lang.StringBuilder(255); 
        	...
        	{
        	    	stringArray_[e] = new java.lang.StringBuilder();	
        	}
        	...
        	nestedSeqTest_ = new us.ihmc.idl.IDLSequence.Object<us.ihmc.idl.generated.IDLNestedElement.NestedElement> (25, us.ihmc.idl.generated.IDLNestedElement.NestedElement.class, new us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType());
    ...
    public void set(IDLElementTest other)
    {
        	...
        	colorTest_ = other.colorTest_;
           	us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType.staticCopy(other.nestedElementTest_, nestedElementTest_);stringTest_.setLength(0);
        	...
        	for(int i = 0; i < nestedArray_.length; ++i)
        	{
        	    ...
        	    {
        	        	us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType.staticCopy(other.nestedArray_[i][j], nestedArray_[i][j]);        	}
        	}
    ...
    public us.ihmc.idl.IDLSequence.Object<us.ihmc.idl.generated.IDLNestedElement.NestedElement>  getNestedSeqTest()
    {
    ...
    public java.lang.String toString()
    {
        ...
        builder.append(java.util.Arrays.toString(this.longArray_));

                builder.append(", ");
        builder.append("nestedArray=");
        builder.append(java.util.Arrays.deepToString(this.nestedArray_));

                builder.append(", ");
        builder.append("stringArray=");
        builder.append(java.util.Arrays.toString(this.stringArray_));
    ...
    private java.lang.StringBuilder[] stringArray_; 
    private us.ihmc.idl.IDLSequence.Char  charSeqTest_; 
    private us.ihmc.idl.IDLSequence.Char  wcharSeqTest_; 
    private us.ihmc.idl.IDLSequence.Byte  octetSeqTest_; 
    private us.ihmc.idl.IDLSequence.Short  shortSeqTest_; 
    private us.ihmc.idl.IDLSequence.Integer  ushortSeqTest_; 
    private us.ihmc.idl.IDLSequence.Integer  longSeqTest_; 
    private us.ihmc.idl.IDLSequence.Long  ulongSeqTest_; 
    private us.ihmc.idl.IDLSequence.Long  longlongSeqtest_; 
    private us.ihmc.idl.IDLSequence.Long  ulonglongSeqTest_; 
    private us.ihmc.idl.IDLSequence.Float  floatSeqTest_; 
    private us.ihmc.idl.IDLSequence.Double  doubleSeqTest_; 
    private us.ihmc.idl.IDLSequence.Boolean  booleanSeqTest_; 
    private us.ihmc.idl.IDLSequence.Object<us.ihmc.idl.generated.IDLNestedElement.NestedElement>  nestedSeqTest_; 
    private us.ihmc.idl.IDLSequence.StringBuilderHolder  stringSeqTest_; 
