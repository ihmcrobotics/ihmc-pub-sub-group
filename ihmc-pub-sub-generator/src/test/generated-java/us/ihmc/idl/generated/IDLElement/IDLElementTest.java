...
public class IDLElementTest extends Packet<IDLElementTest> implements Settable<IDLElementTest>, EpsilonComparable<IDLElementTest>
{
   ...
   public us.ihmc.idl.generated.IDLElement.Color colorTest_;
   public us.ihmc.idl.generated.IDLNestedElement.NestedElement nestedElementTest_;
   public java.lang.StringBuilder stringTest_;
   public int[] longArray_;
   public us.ihmc.idl.generated.IDLNestedElement.NestedElement[][] nestedArray_;
   public java.lang.StringBuilder[] stringArray_;
   public us.ihmc.idl.generated.IDLElement.Color[] enumArray_;
   ...
   public us.ihmc.idl.IDLSequence.Object<us.ihmc.idl.generated.IDLNestedElement.NestedElement>  nestedSeqTest_;
   public us.ihmc.idl.IDLSequence.Enum<us.ihmc.idl.generated.IDLElement.Color> enumSeqTest_;
   public us.ihmc.idl.IDLSequence.StringBuilderHolder  stringSeqTest_;

   public IDLElementTest()
   {
      nestedElementTest_ = new us.ihmc.idl.generated.IDLNestedElement.NestedElement();
      ...
      for(int i1 = 0; i1 < nestedArray_.length; ++i1)
      {
        ...
        {
            nestedArray_[i1][i2] = new us.ihmc.idl.generated.IDLNestedElement.NestedElement();
        }
      }
      ...
      enumArray_ = new us.ihmc.idl.generated.IDLElement.Color[6];
      ...
      enumSeqTest_ = new us.ihmc.idl.IDLSequence.Enum<us.ihmc.idl.generated.IDLElement.Color>(25, us.ihmc.idl.generated.IDLElement.Color.class, us.ihmc.idl.generated.IDLElement.Color.values);
   ...
   public void set(IDLElementTest other)
   {
      ...
      us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType.staticCopy(other.nestedElementTest_, nestedElementTest_);
      ...
      for(int i8 = 0; i8 < nestedArray_.length; ++i8)
      {
         ...
         {
               us.ihmc.idl.generated.IDLNestedElement.NestedElementPubSubType.staticCopy(other.nestedArray_[i8][i9], nestedArray_[i8][i9]);}
      }
   ...
   public us.ihmc.idl.generated.IDLElement.Color[] getEnumArray()
   {
      return enumArray_;
   }
   ...
   public us.ihmc.idl.IDLSequence.Enum<us.ihmc.idl.generated.IDLElement.Color> getEnumSeqTest()
   {
      return enumSeqTest_;
   }
