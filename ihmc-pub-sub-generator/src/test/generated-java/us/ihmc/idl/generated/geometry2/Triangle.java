...
{
   public us.ihmc.idl.generated.geometry2.Vector[] points_;

   public Triangle()
   {
      points_ = new us.ihmc.idl.generated.geometry2.Vector[3];

      for(int i7 = 0; i7 < points_.length; ++i7)
      {
          points_[i7] = new us.ihmc.idl.generated.geometry2.Vector();
      }
   }
   ...
   public void set(Triangle other)
   {
      ...
      {
            us.ihmc.idl.generated.geometry2.VectorPubSubType.staticCopy(other.points_[i9], points_[i9]);}
   }


   public us.ihmc.idl.generated.geometry2.Vector[] getPoints()
   {
      return points_;
   }
