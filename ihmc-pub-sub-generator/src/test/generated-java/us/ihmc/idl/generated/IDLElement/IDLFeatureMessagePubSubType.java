...
*
*/
public class IDLFeatureMessagePubSubType implements us.ihmc.pubsub.TopicDataType<us.ihmc.idl.generated.IDLElement.IDLFeatureMessage>
{
   public static final java.lang.String name = "IDLElement::IDLFeatureMessage";

   private final us.ihmc.idl.CDR serializeCDR = new us.ihmc.idl.CDR();
   private final us.ihmc.idl.CDR deserializeCDR = new us.ihmc.idl.CDR();

   @Override
   public void serialize(us.ihmc.idl.generated.IDLElement.IDLFeatureMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, us.ihmc.idl.generated.IDLElement.IDLFeatureMessage data) throws java.io.IOException
   {
   ...
   public static int getMaxCdrSerializedSize(int current_alignment)
   {
      ...
      current_alignment += us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType.getMaxCdrSerializedSize(current_alignment);
   ...
   public final static int getCdrSerializedSize(us.ihmc.idl.generated.IDLElement.IDLFeatureMessage data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(us.ihmc.idl.generated.IDLElement.IDLFeatureMessage data, int current_alignment)
   {
      int initial_alignment = current_alignment;
      ...
      current_alignment += us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType.getCdrSerializedSize(data.getNum1(), current_alignment);

      current_alignment += 4 + us.ihmc.idl.CDR.alignment(current_alignment, 4);
      for(int i0 = 0; i0 < data.getNum2().size(); ++i0)
      {
          current_alignment += us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType.getCdrSerializedSize(data.getNum2().get(i0), current_alignment);}

      for(int i0 = 0; i0 < data.getNum3().length; ++i0)
      {
              current_alignment += us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType.getCdrSerializedSize(data.getNum3()[i0], current_alignment);
      }
      current_alignment += 4 + us.ihmc.idl.CDR.alignment(current_alignment, 4);
      for(int i0 = 0; i0 < data.getNum4().size(); ++i0)
      {
          current_alignment += us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType.getCdrSerializedSize(data.getNum4().get(i0), current_alignment);}
   ...
   public static void write(us.ihmc.idl.generated.IDLElement.IDLFeatureMessage data, us.ihmc.idl.CDR cdr)
   {
      ...
      us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType.write(data.getNum1(), cdr);
      ...
      for(int i0 = 0; i0 < data.getNum3().length; ++i0)
      {
        	us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType.write(data.getNum3()[i0], cdr);		
      }
   ...
   public static void read(us.ihmc.idl.generated.IDLElement.IDLFeatureMessage data, us.ihmc.idl.CDR cdr)
   {
      ...
      us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType.read(data.getNum1(), cdr);	
      cdr.read_type_e(data.getNum2());	
      for(int i0 = 0; i0 < data.getNum3().length; ++i0)
      {
        	us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType.read(data.getNum3()[i0], cdr);	
      }
   ...
   @Override
   public final void serialize(us.ihmc.idl.generated.IDLElement.IDLFeatureMessage data, us.ihmc.idl.InterchangeSerializer ser)
   {
      ...
      ser.write_type_a("num1", new us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType(), data.getNum1());

      ser.write_type_e("num2", data.getNum2());
      ser.write_type_f("num3", new us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType(), data.getNum3());
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, us.ihmc.idl.generated.IDLElement.IDLFeatureMessage data)
   {
      ...
      ser.read_type_a("num1", new us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType(), data.getNum1());

      ser.read_type_e("num2", data.getNum2());
      ser.read_type_f("num3", new us.ihmc.idl.generated.IDLElement.IDLSubmessagePubSubType(), data.getNum3());
   ...
   public static void staticCopy(us.ihmc.idl.generated.IDLElement.IDLFeatureMessage src, us.ihmc.idl.generated.IDLElement.IDLFeatureMessage dest)
   {
      dest.set(src);
   }

   @Override
   public us.ihmc.idl.generated.IDLElement.IDLFeatureMessage createData()
   {
      return new us.ihmc.idl.generated.IDLElement.IDLFeatureMessage();
   }
   @Override
   ...
   public void serialize(us.ihmc.idl.generated.IDLElement.IDLFeatureMessage data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(us.ihmc.idl.generated.IDLElement.IDLFeatureMessage data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(us.ihmc.idl.generated.IDLElement.IDLFeatureMessage src, us.ihmc.idl.generated.IDLElement.IDLFeatureMessage dest)
   {
      staticCopy(src, dest);
   }
