...
public class XMLSubscriberExample
{
   ...
   public XMLSubscriberExample() throws IOException
   {
      ...
      Participant participant = domain.createParticipant(xml, new ParticipantListenerImpl());

      ChatMessagePubSubType dataType = new ChatMessagePubSubType();
      domain.registerType(participant, dataType);

      Subscriber subscriber = domain.createSubscriber(participant, "INMEM_SUBSCRIBER", dataType, new SubscriberListenerImpl());
   }
